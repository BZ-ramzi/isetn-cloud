		...
		<div class="col-md-12">
			...
			<div class="panel panel-default" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
				...
				<div class="panel-body" style="display: block;">
					<p class="m0">
					N'hésitez pas à nous contacter pour toute question concernant l'usage de l'informatique dans le cadre de vos activités académiques ou administratives à l'ISETN.
						</p>
						<p class="m0">

						<ul>
							<li>Un problème avec votre ordinateur ? </li>
							<li>Un logiciel vous résiste ?</li>
							<li>Besoin d'aide pour utiliser un des services du Ci ? </li>
						</ul>
					</p>
...
<div class="row">
		...
		<div class="info-tile tile-success" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
			...
			<div class="tile-footer"><span class="text-primary"><a href="http://help.isetn.net/" target="_blank">Accéder au service</a> <i class="fa fa-level-down"></i></span></div>
