...
<div class="row">
		...
		<p class="m0">
		Notre plateforme e-learning permet aux éducateurs de créer des cours auxquels les étudiants peuvent accéder en tant que salle de classe virtuelle. qui offre plusieurs services comme: 
		<ul>
			<li>un calendrier partagé</li>
			<li>des questionnaires en ligne</li>
			...
			<li>DS en ligne</li>
					...
					<p class="m0">
						<ul>
							<li>Accès pour tous les étudiants </li>
							<li>Authentification avec votre e-mail et mot de passe ISETN</li>
						</ul>
					</p>
...
<div class="row">
		...
		<div class="info-tile tile-success" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
			...
			<a href="http://fad.isetn.net/" target="_blank">Accéder au service</a>
