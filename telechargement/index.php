		...
		<div class="col-md-12">
			...
			<div class="panel panel-default" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
				...
				<div class="panel-body" style="display: block;">
					<p class="m0">
					    Cet espace de téléchargement propose les dernières mises à jour des outils et logicels que vous souhaite:
					    <ul>
					    	
					    	<li>Système d'exploitation
                                 <ul>
                                 	<li>Windows</li>
                                 	<li>Linux</li>
                                 	<li>FreeBSD</li>
...
<div class="row">
		...
		<div class="info-tile tile-success" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
			...
			<div class="tile-footer"><span class="text-primary"><a href="http://download.isetn.net/" target="_blank">Accéder au service</a> <i class="fa fa-level-down"></i></span></div>
