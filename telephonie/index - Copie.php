...
$row_extension = $isetn->query("SELECT * FROM demande");
$row_row_extension = $row_extension->fetch(PDO::FETCH_ASSOC);
$totalRows_row_extension = $row_extension->rowCount();
...
$row_count_dem = $isetn->query("SELECT * FROM demande WHERE id_service = 3");
