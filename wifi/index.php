		...
		<div class="col-md-12">
			...
			<div class="panel panel-default" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
				<div class="panel-heading">
					<h2>Accès au réseau sans fil</h2>
...
Nos point d'accès WiFi offrent une connexion encryptée qui permet de sécuriser le nom d'utilisateur et le mot de passe, ainsi que les données (confidentialité assurée).
</p>
	<p class="m0">
Connecter à un réseau WiFi de l'ISETN et Accéder au navigateur pour déclencher le portail captif:
<ul>
	<li>Utiliser son adresse e-mail et mot de passe standard (identique à celui de la messagerie ou portail web)</li>
	<ul>
		<li>Adresse e-mail: prénom.nom@isetn.net</li>
