...
$query_row_hebrgement = "SELECT * FROM demande";
$row_hebrgement = mysql_query($query_row_hebrgement, $isetn) or die(mysql_error());
$row_row_hebrgement = mysql_fetch_assoc($row_hebrgement);
$totalRows_row_hebrgement = mysql_num_rows($row_hebrgement);
...
mysql_select_db($database_isetn, $isetn);
$query_row_count_dem = "SELECT * FROM demande WHERE id_service = 1";
