...
$row_hebrgement = $isetn->query("SELECT * FROM demande");
$row_row_hebrgement = $row_hebrgement->fetch(PDO::FETCH_ASSOC);
$totalRows_row_hebrgement = $row_hebrgement->rowCount();
...
$row_res_demande = $isetn->query("SELECT * FROM resultat_demande WHERE utilisateur = ".$colname_row_res_demande);
$row_row_res_demande = $row_res_demande->fetch(PDO::FETCH_ASSOC);
$totalRows_row_res_demande = $row_res_demande->rowCount();



$row_count_dem = $isetn->query("SELECT * FROM demande WHERE id_service = 1");
$row_row_count_dem = $row_count_dem->fetch(PDO::FETCH_ASSOC);
$totalRows_row_count_dem = $row_count_dem->rowCount();
        ...
        <div id="wrapper">
          <div id="layout-static">
                  ...
                  <div class="widget stay-on-collapse" id="widget-sidebar">
                    <nav role="navigation" class="widget-body">
                      <ul class="acc-menu">
                        ...
                        <li><a href="../impression/"><i class="ti ti-printer"></i><span>Impression</span></a> </li>
                        <li><a href="../agenda/"><i class="ti ti-email"></i><span>Mail/Agenda</span></a> </li>
                        <li><a href="../documentation/"><i class="ti ti-files"></i><span>Documentation</span></a> </li>
                        ...
                        <li><a href="../help/"><i class="ti ti-help"></i><span>Help desk</span></a> </li>
                        <br>
                      </ul>
                    </nav>
                  </div>
            ...
            <div class="static-content-wrapper">
                      ...
                      <div class="col-md-12">
                        <div class="panel panel-default" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
                          ...
                          <div class="panel-body" style="display: block;">
                            <p class="m0"> L'hébergement peut se définir comme la prestation d'un service visant à rendre un site Web accessible sur Internet.
                              Afin que vos pages soient visibles par tout le monde il faut qu’elles soient stockées sur un serveur. Le centre informatique garantissent la meilleure accessibilité au site hébergé, grâce aux moyens techniques et à l'expertise dont elles disposent. </p>
                            <p class="m0"> Le <b>Centre informatique</b> (Ci) offre ce service aux enseignants de l'ISETN, chaqu'un peut demander un espace d'hebergement avec un sous domaine "votresite.isetn.net". </p>
                            <p class="m0"> </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="info-tile tile-success" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
                          ...
                          <div>
                            <center>
                              <img src="../assets/img/hebergement.png" width="125px">
                            </center>
                          </div>
			 ...
			 ?>
                              <a href="" data-toggle="modal" data-target="#interdit" >Demander ce service</a>
                              <?php }else{
                         ?>
                              <a href="" data-toggle="modal" data-target="#heberg_service" >Demander ce service</a>
                              <?php

			}} else {?>
                              <a href="../login/?redirect=hebergement">Demander ce service</a>
                              <?php } ?>
                      ...
                      <?php if (($totalRows_row_count_dem > 0) && ($row_row_count_dem['nom_complet']==$_SESSION['cn'])  && ($row_row_count_dem['id_service']=="1")) { // Show if recordset not empty ?>
                        <div class="col-md-3">
                        ...
                        <?php } else { ?>
                        <h3>Espace d'hébergement</h3>
                        <?php } ?>
                    </div>
                    <div class="pricing-footer"> <br>
                        <p> Protéger Vos Coordonnées confidentielles contre l'usurpation. </p>
                      <?php if($row_row_count_dem['statut']=="En attente !"){ ?>
                        <a href="" data-toggle="modal" data-target="#tel_demande_attente" class="btn yellow-crusta"> Voir plus </a>
                        <?php } else { ?>
                        <a href="" data-toggle="modal" data-target="#tel_demande" class="btn yellow-crusta"> Voir plus </a>
                        <?php } ?>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h2 class="modal-title">Information d'espace d'hébergement</h2>
                      </div>
                      <form method="POST" action="">
      <div class="modal-body">
                          <label>Nom complet</label>
                          <input type="text" value="<?php echo $row_row_hebrgement['nom_complet']; ?>" disabled="disabled" name="nom_complet" class="bootbox-input bootbox-input-text form-control">
                          <hr>
						  <label>Mysql-host</label>
                          <input type="text" value="<?php echo $row_row_res_demande['mysql_host']; ?>" disabled="disabled" name="mail1" class="bootbox-input bootbox-input-text form-control">
                         
                          <br>
                           <label>Mysql-user</label>
                          <input type="text" value="<?php echo $row_row_res_demande['mysql_user']; ?>" disabled="disabled" name="nom_complet1" class="bootbox-input bootbox-input-text form-control">
						     
                          <br>
                          <label>Mysql-password</label>
                          <input type="text" value="<?php echo $row_row_res_demande['mysql_password']; ?>" disabled="disabled" name="mail1" class="bootbox-input bootbox-input-text form-control">
						  <br>
						 <label>Mysql-database</label>
                          <input type="text" value="<?php echo $row_row_res_demande['mysql_db']; ?>" disabled="disabled" name="mail1" class="bootbox-input bootbox-input-text form-control">
						  <hr>
						   <label>Ftp-host</label>
                          <input type="text" value="<?php echo $row_row_res_demande['ftp_host']; ?>" disabled="disabled" name="mail1" class="bootbox-input bootbox-input-text form-control">
						       
                          <br>
                          <label>Ftp-user</label>
                          <input type="text" value="<?php echo $row_row_res_demande['ftp_user']; ?>" disabled="disabled" name="nom_complet1" class="bootbox-input bootbox-input-text form-control">
                          <br>
                          <label>Ftp-password</label>
                          <input type="text" value="<?php echo $row_row_res_demande['ftp_password']; ?>" disabled="disabled" name="mail1" class="bootbox-input bootbox-input-text form-control">
						  <br>
						    <label>Ftp-port</label>
                          <input type="text" value="21" disabled="disabled" name="mail1" class="bootbox-input bootbox-input-text form-control">
						  <hr>
						    <label>Site web</label>
                          <input type="text" value="<?php echo $row_row_count_dem['sdomaine']; ?>" disabled="disabled" name="mail1" class="bootbox-input bootbox-input-text form-control">
                ...
                <div class="modal fade" id="tel_demande_attente" >
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-body">
                        <center>
                          <img src="../assets/img/loading.png"><br>
                ...
                <div class="modal fade" id="heberg_service" >
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h2 class="modal-title">Demande d'un espace d'hébegement</h2>
                      </div>
                      ...
                      <form method="POST" action="demande.php">
                        <div class="modal-body">
                          <label>Nom complet</label>
                          <input  type="text" value="<?php  echo $_SESSION['cn']; ?>" name="" disabled="disabled" class="bootbox-input bootbox-input-text form-control">
                          <input  type="text" value="<?php  echo $_SESSION['cn']; ?>"  name="nom_complet" style="display:none;">
                          <br>
                          <label>Email</label>
                          <input  type="text" value="<?php  echo $_SESSION['user']; ?>" name="" disabled="disabled" class="bootbox-input bootbox-input-text form-control">
                          <input  type="text" value="<?php  echo $_SESSION['user']; ?>"   name="mail" style="display:none;">
                          <br>
                          <label>Catégorie</label>
                          <input  type="text" value="<?php  echo $_SESSION['access2']; ?>" name="" disabled="disabled" class="bootbox-input bootbox-input-text form-control">
                          <input  type="text"  value="<?php echo $_SESSION['access2']; ?>" name="categorie" style="display:none;">
                          <br>
                          <label>Sous domaine</label>
                          <input  type="text" value="" required  name="sdomaine" placeholder="votresite.isetn.net" class="bootbox-input bootbox-input-text form-control">
                          <br>
					  ...
					  <?php } else if(($totalRows_row_count_dem >= 1) && ($row_row_count_dem['id_service'] == "1" )){ ?>
        ...
        <footer role="contentinfo">
          <div class="clearfix">
            <ul class="list-unstyled list-inline pull-left">
              <li>
                <h6 style="margin: 0;">Made with <span class="fa fa-heart"></span> by <a href="../ci/" target="_blank">Centre Informatique</a></h6>
              </li>
            </ul>
...
<?php
mysql_free_result($row_hebrgement);
