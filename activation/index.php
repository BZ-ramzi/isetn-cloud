		...
		<div class="col-md-12">
			...
			<div class="panel panel-default" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
				...
				<div class="panel-body" style="display: block;">
					<p class="m0">
						Pour obtenir un accès, il est obligatoire de remplir le <a href="">formuaire adéquat</a> et de le faire parvenir au Centre informatique. Il en est de même pour la modification du profil dans l'intranet administratif.
						</p>
						<p class="m0">

						 Les règles de gestion des comptes (céation et blocage) ne sont pas les mêmes pour tout le monde; elles dépendent de l'unité structurelle (ou groupe) à laquelle chaque personne appartient. Chacun peut consulter les règles s'appliquant à sa propre situation à partir de la liste ci-dessous.

						 </p>
						 <p><b>Clés d'accès (Adresse e-mail et mot de passe)</b> </p>
						 <ul>
						 	<li>Elles sont envoyées par courrier confidentiel à votre e-mail.</li>
						 </ul>
						 <p>
						<b>Règles générales pour le blocage et fermeture des comptes</b>
						 <ul>
						 	<li>Les accès Intranet et Services sont bloqués sans avertissement le jour de la fin du droit (fin de contrat, fin des études, exmatriculation).</li>
						 	<li>Les accès sont prolongés de 6 mois après la date de la fin du droit avec une demande par l'utilisateur.</li>
						 	<li>Un mois avant le blocage du compte, le propriétaire reçoit un message électronique annonçant le prochain blocage.</li>
						 	<li>Un an après le blocage les données de l'utilisateur sont détruites.</li>
