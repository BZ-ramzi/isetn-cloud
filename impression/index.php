		...
		<div class="col-md-12">
			...
			<div class="panel panel-default" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
				...
				<div class="panel-body" style="display: block;">
					...
					<p class="m0">
						PrintOffice est un projet qui s'inscrit dans une démarche de gestion centralisée d'une partie des impressions effectuées sur le campus. Avec PrintISETN, le Ci propose déjà un système d'impression publique, destinée prioritairement aux étudiants. 

						Le projet PrintOffice est lui exclusivement destiné aux facultés et aux services ISETN.
						</p>
                        ...
                        <li>Réduire les coûts d'impression et de maintenance du matériel pour l'institut</li>
                        <li>D'adopter un comportement plus responsable et écologique vis-à-vis du besoin d’impression</li>
                        <li>De disposer de statistiques d’impression</li>
