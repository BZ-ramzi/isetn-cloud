		...
		<div class="col-md-12">
			...
			<div class="panel panel-default" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
				...
				<div class="panel-body" style="display: block;">
					<p class="m0">
						<b>Blocage des accès</b></p>
						<p>
Pour les étudiants, le blocage des accès est automatique; il est effectué 6 mois après la date d'exmatriculation. Pour les membres du personnel, ce blocage a lieu 6 mois après la fin du contrat de travail.</p>
						<p class="m0">

						Chacun doit prendre les mesures adéquates pour définir une autre adresse email privée avant le blocage. Il n'est pas accordé de prolongation pour le motif de correspondance email active avec l'email ISETN, quel qu'en soit la teneur (recherche d'emploi, collaboration scientifique, email inscrit sur des publications). 
					</p>
					<p>Les personnes, bénéficiant du délai de 6 mois avant le blocage, sont averties par un message email 1 mois avant le blocage.</p>
					<p class="m0">
					<b>Fermeture des accès</b></p>
					<p>
					La fermeture d'un accès signifie la destruction définitive des données personnelles associées à cet accès. Les données personnelles ne sont pas archivées; il est donc impossible de les récupérer après la fermeture.
</p>
<p>
	Attention, pour de nombreux services, il faut se renseigner auprès des responsables pour  savoir quand sont détruits les donnnées personnelles. Il faut prendre garde en particulier aux services suivants:
	<ul>
		<li>Les serveurs de fichiers décentralisés</li>
		<li>Les applications liées à l'enseignement (moodle)</li>
	</ul>
